...
<body>
    ...
    <div class="publicar">
        <form method="post">
            <input type="text" required placeholder="encabezado" class="publi1" name="ePPcabezado" autocomplete="off">
            ...
            <input type="submit" value="enviar mensaje" name="guardar" class="publi4">
        </form>
        <?php
